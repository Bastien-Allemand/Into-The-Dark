...
public class PickUpScript : MonoBehaviour
{
    ...
    void PlaceItem(GameObject handItem)
    {
        ...
        handItem.transform.position = new Vector3(preview.transform.position.x, preview.transform.position.y + (handItem.transform.localScale.y / 2), preview.transform.position.z);
